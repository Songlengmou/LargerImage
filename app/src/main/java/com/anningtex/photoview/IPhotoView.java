...
public interface IPhotoView {
    ...
    /**
     * Register shop_car_second_layout callback to be invoked when the Photo displayed by this view is long-pressed.
     *
    ...
    /**
     * Register shop_car_second_layout callback to be invoked when the Matrix has changed for this View. An example would
    ...
    /**
     * Register shop_car_second_layout callback to be invoked when the Photo displayed by this View is tapped with shop_car_second_layout
     * single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Returns shop_car_second_layout listener to be invoked when the Photo displayed by this View is tapped with shop_car_second_layout
     * single tap.
     *
     * @return PhotoViewAttacher.OnPhotoTapListener currently set, may be null
     */
    PhotoViewAttache.OnPhotoTapListener getOnPhotoTapListener();

    /**
     * Register shop_car_second_layout callback to be invoked when the View is tapped with shop_car_second_layout single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Returns shop_car_second_layout callback listener to be invoked when the View is tapped with shop_car_second_layout single tap.
     *
     * @return PhotoViewAttacher.OnViewTapListener currently set, may be null
     */
    PhotoViewAttache.OnViewTapListener getOnViewTapListener();
